...
global.controls[i, cr.hor] = keyboard_check(vk_right) - keyboard_check(vk_left); //move left/right
global.controls[i, cr.Attack] = keyboard_check(vk_down); //attack
global.controls[i, cr.Jump] = keyboard_check(ord(vk_up)); // jump
global.controls[i, cr.AttackPressed] = keyboard_check_pressed(vk_down);
global.controls[i, cr.JumpPressed] = keyboard_check_pressed(vk_up);
